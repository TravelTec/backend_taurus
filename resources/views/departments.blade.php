            ...
            <nav class="navbar navbar-expand-lg" id="navbar-secundaria">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown2">
                  <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="user?a=<?=$_SESSION['license_id']?>">
                          Dependents
                        </a>
                    </li>
                  </ul>
    ...
    <main id="container" class="">
        <div id="container__principal" class="bg-white row m-0"> 
            <div id="" class="col-sm-12 p-0"> 
                <div id="mensagem__taurus" class="flex-column align-items-center justify-content-center bg-light" style=" height: 500px; display: block;">
                    <?php
