$(document).ready(function() {
                ...
                swal({
                    ...
                    if (isConfirm) {
                        swal({
                          ...
                          text: "Você voltará a sua área de compra",
                          type: "error",
        ...
        function incluirCreditosAdicionais(valor, qtd){


                  $.ajax({
                    url: 'functions/VencimentoCreditos.php',
                    type: 'POST',
                    success: function(resposta){
                        var vencimento = resposta;

                        $('.exibVencimento').prop("value", vencimento);

                    swal({
                      html: true,
                      title: 'Créditos adicionais',
                      text: "<div class='col-sm-12' style='text-align: left;padding-left: 110px; margin-bottom: 20px;'><div class='row'><strong>Quantidade:</strong> "+qtd+"</div><div class='row'><strong>Total</strong>: R$"+valor+"</div><div class='row'><strong>Validade:</strong> "+vencimento+"</div></div><div class='row' style='padding: 2px; margin-bottom: 10px; font-size: 17px;'>Para prosseguir clique em confirmar</div><div class='row' style='font-size: 17px;padding: 2px;'>Caso tenha dúvidas <a onclick='duvidaAquisicao(2)' style='font-size: 18px; font-weight: 600'>Clique aqui</a></div>",
                      imageUrl: "img/financeiro.png",
                      imageSize: "120x120",
                      showCancelButton: true,
                      closeOnConfirm: true,
